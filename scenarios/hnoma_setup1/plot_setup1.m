...
hnoma_std = load('./hnoma_setup1/hnoma_std.mat');
hnoma_ps0515 = load('./hnoma_setup1/hnoma_0515.mat');
hnoma_ps0416 = load('./hnoma_setup1/hnoma_0416.mat');
hnoma_ps0317 = load('./hnoma_setup1/hnoma_0317.mat');
hnoma_ps0218 = load('./hnoma_setup1/hnoma_0218.mat');
hnoma_ps0119 = load('./hnoma_setup1/hnoma_0119.mat');

lambda_std = hnoma_std.Lambda_m_non;
...
env_lambda = zeros(1,length(hnoma_ps0515.rBf));
...
setup1 = [rBf_std; env_lambda];
save('./hnoma_setup1/setup1.mat','setup1');
...
% Adicionar legenda para o eixo y em toda a imagem
hAx = axes('Position',[0 0 1 1],'Visible','off');
hYLabel = ylabel(hAx, 'Eixo Y');
set(hYLabel, 'Visible', 'on', 'Position', [-0.1, 0.5, 0]);
