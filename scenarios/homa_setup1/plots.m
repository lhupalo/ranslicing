...
homa_0119 = load('homa_0119.mat');
homa_0218 = load('homa_0218.mat');
homa_0317 = load('homa_0317.mat');
homa_0416 = load('homa_0416.mat');
homa_0515 = load('homa_0515.mat');
...
for i = 1:length(homa_std.alpha)
    ...
    env_lambda(i) = max(max(homa_std.max_devices(i)),max(lst));
end
