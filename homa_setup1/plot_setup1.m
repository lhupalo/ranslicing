...
homa_std = load('./homa_setup1/homa_std.mat');
homa_0119 = load('./homa_setup1/homa_0119.mat');
homa_0218 = load('./homa_setup1/homa_0218.mat');
homa_0317 = load('./homa_setup1/homa_0317.mat');
homa_0416 = load('./homa_setup1/homa_0416.mat');
homa_0515 = load('./homa_setup1/homa_0515.mat');

env_lambda = zeros(1,length(homa_0515.alpha));
for i = 1:length(homa_0515.alpha)
...
% hold on;
plot(homa_0515.rBf,env_lambda,'+-b','LineWidth',2);
...
setup1 = [homa_0515.rBf; env_lambda];
save('./homa_setup1/setup1.mat','setup1');
