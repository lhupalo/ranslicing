...
homa_std = load('./homa_setup2/homa_std.mat');
homa_0119 = load('./homa_setup2/homa_0119.mat');
homa_0218 = load('./homa_setup2/homa_0218.mat');
homa_0317 = load('./homa_setup2/homa_0317.mat');
homa_0416 = load('./homa_setup2/homa_0416.mat');
homa_0515 = load('./homa_setup2/homa_0515.mat');
...
plot(homa_std.rBf(:,1),homa_std.max_devices(:,1),'-or','LineWidth',2);
hold on
plot(homa_std.rBf(:,1),homa_0119.maxdevices,'+-b','LineWidth',2);
hold on
plot(homa_std.rBf(:,1),homa_0218.maxdevices,'-xm','LineWidth',2);
hold on
plot(homa_std.rBf(:,1),homa_0317.maxdevices,'-sk','LineWidth',2);
hold on
plot(homa_std.rBf(:,1),homa_0416.maxdevices,'-dg','LineWidth',2);
hold on
plot(homa_std.rBf(:,1),homa_0515.maxdevices,'color',[0.4940, 0.1840, 0.5560],'marker','^','LineWidth',2);
% xlabel('$\alpha$','Interpreter','latex','fontsize',12)
xlabel('$r_B$ [bits/s/Hz]','Interpreter','latex','fontsize',12)
ylabel('$\lambda_M$ [number of active devices]','Interpreter','latex','fontsize',12)
title('H-OMA with clustering procedure')
legend('Standard H-OMA','$\boldsymbol{\beta}_5 = [1.9\;0.1]$','$\boldsymbol{\beta}_4 = [1.8\;0.2]$','$\boldsymbol{\beta}_3 = [1.7\;0.3]$','$\boldsymbol{\beta}_2 = [1.6\;0.4]$', '$\boldsymbol{\beta}_1 = [1.5\;0.5]$','Location','Best')
grid on
